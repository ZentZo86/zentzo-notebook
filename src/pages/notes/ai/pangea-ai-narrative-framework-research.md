...
title: "PANGeA: 程序化 AI 叙事框架深度调研"
date: 2026-02-03
category: AI研究
tags: [AI叙事, 独立游戏, LLM, Unity, 程序化生成]
excerpt: "调研 SMU Guildhall 开发的 PANGeA 框架，探索如何通过验证系统让本地小模型（如 Llama-3）在保持叙事一致性的前提下实现动态剧情生成。"
---
...
*   **小模型性能跃升**：实验显示，配合验证系统后，**Llama-3 (8B)** 的叙事逻辑准确率从 28% 提升至 **98%**，表现接近 GPT-4。
